...
class exportmagento2xcategories(models.TransientModel):
    ...
    def magento2x_get_category_data(self, category_id, channel_id):
        ...
        if category_id.parent_id:
            store_parent_id = channel_id.match_category_mappings(
    ...
    @api.model
    def magento2x_post_categories_bulk_data(self,sdk,channel_id,category_ids,operation):
        if operation == 'export':
            post_res=self.magento2x_create_category_data(sdk,category_ids,channel_id,'bulk')
        else:
            post_res=self.magento2x_update_category_data(sdk,channel_id,category_ids,'bulk')
