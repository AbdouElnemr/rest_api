...
class exportmagento2xattributes(models.TransientModel):
    ...
    _description = "export.attributes.magento"
    ...
    def create_magento2x_update_value_mapping(self,sdk,channel_id,attribute_ids):
        ...
        #     value = attribute_ids.mapped
        #     condition_type = 'inset'
        # )
    ...
    @api.model
    def magento2x_post_attributes_data(self,sdk,channel_id,attribute_ids):
        message = ''
        ...
        for record in self:
            ...
            if not sdk:
                ...
                exclude_res=record.exclude_export_data(
                    record.attribute_ids,channel_id,record.operation,model='attribute'
                )
                ...
                if not len(attributes):
                    ...
                    post_res=record.magento2x_post_attributes_data(sdk,channel_id,attributes)
