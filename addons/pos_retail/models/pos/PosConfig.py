...
class PosConfig(models.Model):
    ...
    html_footer = fields.Text('Html9 Footer of Receipt', compute='default_footter_receipt_template')

    # default footer
    def default_footter_receipt_template(self):
        print('zainab DEV...........')
        x = """<center><span>TERMS & CONDITIONS APPLY.</span><br/>
            <span>
            Please confirm items with reviewing invoice prior to leaving store.
            </span><br/>
            <strong>Return & Exchange Policy</strong>
           <br/> <span>Exchanges Within 14 Days/ Refunds Within 7 Days with Original Invoice & Goods In</span><br/>
            <span>Resalable Condition In Their Original Packaging. No Exchange/Refund If the Original<br/>Packaging Is Damaged/Opened.</span><br/>
            <span>All The Refunds Will Be Issued in The Form of Original Payment.</span><br/>
            <span>Goods Once Exchange Cannot Be Re-Exchanged More Than Once or Can Be Refunded.</span>
            <div style="text:center">
                <span>يرجى تأكيد العناصر مع مراجعة الفاتورة قبل مغادرة المتجر.</span><br/>
             <strong>سياسة الاسترجاع  والاستبدال</strong></br>
            <span>
            الاستبدال خلال 14 يوم /  الاسترجاع خلال 7 ايام من تاريخ الفاتورة بشرط ان 
            </span><br/>
            <span>تكون البضاعة بحالة جيدة (نفس حالة الشراء).</span><br/>
            <span>استرجاع قيمة الفاتورة بنفس طريقة الدفع المسجلة بالفاتورة.</span><br/>
            <span>لا يمكن استبدال البضاعة غير مرة واحدة  ولا يمكن استرجاع البضاعة المستبدلة مرة أخرى.</span>
            <br/>
            <center>---------------------------------------------------------------------------------------------------------</center><br/>
            <span style='text-center'>FOR CUSTOMER CARE/CONCERN PLEASE EMAIL<a href='boxpark@babolat.ae'> boxpark@babolat.ae</a>
            </span>
            """
        self.html_footer = x
